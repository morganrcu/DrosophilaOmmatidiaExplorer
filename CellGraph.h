...
template<class TCell, class TCellEdge> class CellGraph: public itk::DataObject {
...
private:
	...
	typedef boost::property<CellVertexPropertyTag, typename TCell::Pointer, boost::property<boost::vertex_index_t, int> > VertexProperty;
...
public:
	...
	typedef TCellEdge CellEdgeType;
	...
	CellVertexHandler GetUnboundedFace() {
		return m_UnboundedFace;
	}
	void SetUnboundedFace(const CellVertexHandler & unboundedFace) {
		m_UnboundedFace = unboundedFace;
	}
...
private:
	...
	CellVertexHandler m_UnboundedFace;
